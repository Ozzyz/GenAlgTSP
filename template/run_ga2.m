function [r_path, r_dist, r_gen, r_best_fits, r_mean_fits, r_worst_fits] = run_ga2(x, y, NIND, MAXGEN, NVAR, ELITIST, STOP_PERCENTAGE, PR_CROSS, PR_MUT, CROSSOVER, LOCALLOOP, PARENT_SELECTION, MUTATION, MU_LAMBDA)
% usage: [r_path, r_dist, 
%         r_gen, r_best_fits, 
...
%{NIND MAXGEN NVAR ELITIST STOP_PERCENTAGE PR_CROSS PR_MUT CROSSOVER LOCALLOOP} 
    ...
    while gen<MAXGEN
        ...
        % if mu_lambda is true, do  (µ, ?) survivor selection
        if MU_LAMBDA
